...
//        ReflectionTestUtils.setField(defaultPersistenceService, "valueTemplate", valueTemplate);
    ...
    public void whenOrderingKeyPrefixThenShouldNotChange() {
        ...
        //Act
        final String givenPrefix = defaultPersistenceService.orderingKeyPrefix();
    ...
    public void add() throws Exception {
        ...
        final String expectedOrderingKey = defaultPersistenceService.orderingKeyPrefix()+assignedPriority;
